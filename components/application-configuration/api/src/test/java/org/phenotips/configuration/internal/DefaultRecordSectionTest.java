...
public class DefaultRecordSectionTest
{
    ...
    private final UIExtensionManager uixManager = mock(UIExtensionManager.class);

    private final UIExtensionFilter orderFilter = mock(UIExtensionFilter.class);
    ...
    {
        RecordSection s = new DefaultRecordSection(this.uiExtension, this.uixManager, this.orderFilter);
    ...
    public void throwExceptionIfExtensionNull()
    {
        ...
        new DefaultRecordSection(null, this.uixManager, this.orderFilter);
    }
    ...
    {
        this.thrown.expect(IllegalArgumentException.class);
        new DefaultRecordSection(this.uiExtension, null, this.orderFilter);
    }
    ...
    {
        this.thrown.expect(IllegalArgumentException.class);
        new DefaultRecordSection(this.uiExtension, this.uixManager, null);
    }
