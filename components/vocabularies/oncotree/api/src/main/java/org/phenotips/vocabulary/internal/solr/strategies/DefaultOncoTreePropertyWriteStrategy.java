...
/**
 * Default implementation of a {@link OncoTreePropertyWriteStrategy}. This will write the property name and value as is.
 *
 * @version $Id$
 * @since 1.4
 */
public class DefaultOncoTreePropertyWriteStrategy implements OncoTreePropertyWriteStrategy
{
    @Override
