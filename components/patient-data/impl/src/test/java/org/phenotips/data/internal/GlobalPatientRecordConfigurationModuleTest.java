...
public class GlobalPatientRecordConfigurationModuleTest
{
    ...
    public final MockitoComponentMockingRule<RecordConfigurationModule> mocker =
        new MockitoComponentMockingRule<RecordConfigurationModule>(GlobalPatientRecordConfigurationModule.class);
    ...
    /**
     * Tests that {@link GlobalPatientRecordConfigurationModule#process(RecordConfiguration)} returns configuration
    ...
    /**
     * Tests that {@link GlobalPatientRecordConfigurationModule#getPriority()} returns correct priority for module.
     */
    @Test
    ...
    /**
     * Tests that {@link GlobalPatientRecordConfigurationModule#getSupportedRecordTypes()} returns correct types.
     */
    @Test
    ...
    /**
     * Tests that {@link GlobalPatientRecordConfigurationModule#supportsRecordType(java.lang.String)} returns true if
     * record is of type "patient".
     */
    @Test
    ...
    /**
     * Tests that {@link GlobalPatientRecordConfigurationModule#supportsRecordType(java.lang.String)} returns false if
     * record is not of type "patient".
     */
    @Test
    ...
    /**
     * Tests that {@link GlobalPatientRecordConfigurationModule#supportsRecordType(java.lang.String)} returns false if
     * record type is null or empty string.
     */
    @Test
