...
public class DefaultConsentAuthorizerTest
{
    ...
    public final MockitoComponentMockingRule<ConsentAuthorizer> mocker =
        new MockitoComponentMockingRule<ConsentAuthorizer>(DefaultConsentAuthorizer.class);
    ...
    /**
     * Tests that {@link DefaultConsentAuthorizer#consentsGloballyEnabled()} returns false if the set of system
     * consents is empty.
     */
    @Test
    ...
    /**
     * Tests that {@link DefaultConsentAuthorizer#consentsGloballyEnabled()} returns true if the set of system
     * consents is not empty.
     */
    @Test
    ...
    {
        final RecordElement recordElementA = mock(DefaultRecordElement.class);
        final RecordElement recordElementB = mock(DefaultRecordElement.class);
        final RecordElement recordElementC = mock(DefaultRecordElement.class);
    ...
    public void isElementConsentedConsentsDoNotAffectAnyFields()
    {
        ...
        final List<String> nonConsentedFields = Arrays.asList(FIELD_A_LABEL, FIELD_B_LABEL);
        when(consentA.getFields()).thenReturn(nonConsentedFields);
