...
public class DefaultConsentAuthorizer implements ConsentAuthorizer
{
    ...
    /**
     * Given a set of {@code missingConsents missing consents} for a {@link Patient} object, returns true iff none of
     * the {@code missingConsents} is required ({@link Consent#isRequired()}), false otherwise.
     *
    ...
    /**
     * Given a form {@code element} and a set of {@code nonConsentedFields non consented elements}, returns true
     * iff {@code element} is enabled, false otherwise.
     *
    ...
    {
        return !nonConsentedFields.contains(element.getExtension().getId());
    }

    /**
     * Given a set of {@code missingConsents missing consents}, returns the union of all
     * {@link Consent#getFields() fields}, which the provided set of {@code missingConsents} prevents from being used.
     * Returns an empty set if no fields are affected.
     *
